...
func mockInterfaceByName() func() {
	...
	return func() { interfaceByNameFn = prevFunc }
}

func mockNewOVSBridge(brClient ovsconfig.OVSBridgeClient) func() {
	...
	return func() { newOVSBridgeFn = prevFunc }
}
