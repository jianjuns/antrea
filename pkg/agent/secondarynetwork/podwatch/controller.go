...
type IPAMAllocator interface {
	SecondaryNetworkAllocate(podOwner *crdv1a2.PodOwner, networkConfig *types.NetworkConfig) (*current.Result, error)
...
func (pc *PodController) configureSecondaryInterface(
	...
	result, err := pc.ipamAllocator.SecondaryNetworkAllocate(podOwner, &networkConfig.NetworkConfig)
	if err != nil {
