...
func TestStaleController_CleanupService(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existSvcList, tt.existSvcImpList).Build()
			fakeRemoteClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existingResImpList).Build()
			commonArea := commonarea.NewFakeRemoteCommonArea(fakeRemoteClient, "leader-cluster", common.localClusterID, "default", nil)
			mcReconciler := member.NewMemberClusterSetReconciler(fakeClient, common.scheme, "default", false)
			mcReconciler.SetRemoteCommonArea(commonArea)
			c := NewStaleResCleanupController(fakeClient, common.scheme, "default", mcReconciler, MemberCluster)
...
func TestStaleController_CleanupACNP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existingACNPList).Build()
			fakeRemoteClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existingResImpList).Build()
			commonArea := commonarea.NewFakeRemoteCommonArea(fakeRemoteClient, "leader-cluster", common.localClusterID, "default", nil)
...
func TestStaleController_CleanupResourceExport(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existSvcExpList, tt.existPodList, tt.existNamespaceList).Build()
			fakeRemoteClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existResExpList).Build()
			commonArea := commonarea.NewFakeRemoteCommonArea(fakeRemoteClient, "leader-cluster", common.localClusterID, "default", nil)
...
func TestStaleController_CleanupClusterInfoImport(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existCIImpList).Build()
			fakeRemoteClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existingResImpList).Build()
...
func TestStaleController_CleanupMemberClusterAnnounce(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.memberClusterAnnounceList).WithLists(tt.clusterSet).Build()

			mcReconciler := member.NewMemberClusterSetReconciler(fakeClient, common.scheme, "default", false)
			c := NewStaleResCleanupController(fakeClient, common.scheme, "default", mcReconciler, LeaderCluster)
...
func TestStaleController_CleanupLabelIdentites(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existLabelIdentityList).Build()
			fakeRemoteClient := fake.NewClientBuilder().WithScheme(common.scheme).WithLists(tt.existingResImpList).Build()
