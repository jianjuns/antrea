...
func (r *LeaderClusterSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if r.clusterSetConfig == nil {
		clusterID, clusterSetID, err := controllers.validateLocalClusterClaim(r.Client, clusterSet)
		if err != nil {
			return ctrl.Result{}, err
		}
		if err = controllers.validateConfigExists(clusterID, clusterSet.Spec.Leaders); err != nil {
...
func (r *LeaderClusterSetReconciler) updateStatus() {
	...
	clusterStatuses := GetMemberClusterStatuses()
