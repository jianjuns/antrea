...
func (r *GatewayReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	commonArea, r.localClusterID, err = GetRemoteCommonAreaAndLocalID()
	if commonArea == nil {
...
func (r *GatewayReconciler) getServiceCIDR(ctx context.Context) error {
	if len(r.serviceCIDR) == 0 {
		serviceCIDR, err := controllers.findServiceCIDRByInvalidServiceCreation(ctx, r.Client, r.namespace)
		if err != nil {
